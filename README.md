...
Yes, if you use a YouTube link, the software needs a connection to fetch the video data. For local audio files, you can work offline.

**Can it translate audio?**
The current version excels at transcription in the original language. It focuses on turning speech into readable text.

**Why is my audio not transcribing?**
Check your file format. The tool supports standard audio formats like MP3, WAV, and M4A. Ensure your file is not corrupted.

**Can I change the output destination?**
Yes, browse to your preferred folder before clicking start.
